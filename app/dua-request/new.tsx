  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const successMessage = isOffline
        ? 'درخواست ثبت شد، اما آفلاین هستید. پس از اتصال ارسال می‌شود و سیدعبدالباقی پاسخ می‌دهد.'
        : 'درخواست ثبت شد؛ پاسخ سیدعبدالباقی با دعا و ذکر به‌زودی می‌آید (معمولاً بین حدود ۱۰ تا ۶۰ دقیقه).';
