...
export function buildWidgetSnapshot(
  ...
  return {
    ...
    weekdayEnglish: active.weekdayEnglish,
    shamsiDisplay: active.shamsiDisplay,
    shamsiDisplayPashto: active.shamsiDisplayPashto,
    shamsiDisplayEnglish: active.shamsiDisplayEnglish,
    ...
    sunriseDisplayEnglish: active.sunriseDisplayEnglish,
    currentPrayer,
...
export function refreshWidgetSnapshot(snapshot: WidgetSnapshot, now: Date = new Date()): WidgetSnapshot {
  ...
  return {
    ...
    weekdayEnglish: active?.weekdayEnglish || WEEKDAYS_ENGLISH[truth.weekday],
    ...
    shamsiDisplayEnglish: active?.shamsiDisplayEnglish || formatShamsiSlash(truth.shamsi, 'english'),
    hijriDisplay:
      active?.hijriDisplay ||
    ...
    sunriseDisplayEnglish: active?.sunriseDisplayEnglish || snapshot.sunriseDisplayEnglish || '',
